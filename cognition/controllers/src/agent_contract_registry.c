...
static const struct agent_contract_command_surface g_agent_command_surfaces[] = {
    ...
    CATALOG_COMMAND("agentinterface.visual_instruments", 7, "code_growth",
      "app.presentation.code-growth",
      "chart exact Git-derived daily C23 line totals with hover evidence"),
    ...
    CATALOG_COMMAND("agentinterface.visual_instruments", 10,
