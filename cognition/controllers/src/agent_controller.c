...
static bool agent_path_is_native_agent_api(const char *path)
{
    static const char *const paths[] = {
        "cognition/controllers/src/agent_controller.c", "cognition/controllers/src/agent_background_quality.c", "cognition/controllers/src/agent_anchor_status_controller.c", "cognition/controllers/src/agent_diagnose_controller.c", "cognition/controllers/src/agent_impact_rules.c", "cognition/controllers/src/agent_interface_controller.c",
        "cognition/controllers/src/agent_contracts_controller.c", "cognition/controllers/src/agent_lane_runtime.c", "cognition/controllers/src/agent_lanes_controller.c", "cognition/controllers/src/agent_liveness_controller.c", "cognition/controllers/src/agent_operator_contracts.c", "cognition/controllers/src/agent_ops_controller.c", "cognition/controllers/src/agent_resources.c", "cognition/controllers/src/agent_restart_watchdog.c",
        "cognition/controllers/src/agent_runtime_controller.c", "cognition/controllers/src/agent_first_call.c", "cognition/controllers/src/event_agent_peers.c", "cognition/controllers/src/event_agent_summary.c", "engine/controllers/src/event_operator_snapshot_controller.c", "engine/controllers/include/controllers/event_operator_snapshot_controller.h", "engine/services/src/operator_snapshot_service.c", "engine/services/include/services/operator_snapshot_service.h", "engine/services/include/services/operator_peer_snapshot_service.h",
        "cognition/controllers/src/event_agent_summary.h", "engine/controllers/src/event_timeline_controller.c", "engine/controllers/src/event_timeline_filter_controller.c", "engine/controllers/include/controllers/event_timeline_controller.h", "engine/controllers/include/controllers/event_timeline_filter_controller.h", "cognition/controllers/include/controllers/agent_controller.h", "cognition/controllers/include/controllers/agent_background_quality.h", "cognition/controllers/include/controllers/agent_contracts.def", "cognition/controllers/include/controllers/agent_impact_rules.def",
        "cognition/controllers/include/controllers/agent_first_call.h", "cognition/controllers/include/controllers/agent_impact_rules.h", "cognition/controllers/include/controllers/agent_operator_contracts.h", "cognition/controllers/include/controllers/agent_resources.h", "cognition/controllers/include/controllers/agent_restart_watchdog.h",
        "engine/controllers/src/diagnostics_registry.c", "engine/controllers/src/diagnostics_controller.c", "engine/controllers/include/controllers/diagnostics_controller.h", "engine/controllers/include/controllers/diagnostics_internal.h",
    };
                                       ...
                                       const char **docs_out)
{
    ...
    if (!path || !path[0]) {
        ...
        acc->code_changed = true;
    } else if (strcmp(path, "engine/controllers/src/event_controller.c") == 0) {
        subsystem = "native_status_api";
        risk = "operator_api";
        docs = "docs/AGENT_API.md";
        acc->agent_api_changed = true;
        acc->code_changed = true;
    } else if (strcmp(path, "engine/controllers/src/health_controller.c") == 0 ||
               strcmp(path,
                      "engine/controllers/include/controllers/health_controller.h") == 0) {
        subsystem = "native_status_api";
        risk = "operator_api";
        docs = "docs/AGENT_API.md";
        acc->agent_api_changed = true;
        acc->code_changed = true;
    } else if (strcmp(path, "engine/entry/main.c") == 0) {
        subsystem = "native_cli_api";
        risk = "operator_api";
        docs = "docs/AGENT_API.md";
        acc->agent_api_changed = true;
        acc->code_changed = true;
    } else if (agent_str_starts(path, "engine/controllers/src/api_controller")) {
        subsystem = "rest_agent_api";
        risk = "operator_api";
        docs = "docs/CODEBASE_MAP.md";
        acc->agent_api_changed = true;
        acc->code_changed = true;
    } else if (strcmp(path, "engine/services/src/node_health_service.c") == 0 ||
               agent_str_starts(path,
                                "engine/services/include/services/node_health_service")) {
        ...
        acc->code_changed = true;
               ...
               agent_str_starts(path, "core/modules/chain/") ||
               agent_str_starts(path, "core/modules/validation/") ||
               agent_str_starts(path, "core/modules/script/") ||
               agent_str_starts(path, "core/modules/primitives/")) {
        subsystem = "consensus_or_validation";
        risk = "consensus_parity";
        docs = "docs/CONSENSUS_PARITY_DOCTRINE.md";
        acc->consensus_risk = true;
        acc->code_changed = true;
    } else if (agent_str_starts(path, "engine/jobs/")) {
        ...
        acc->code_changed = true;
    } else if (agent_str_starts(path, "engine/services/")) {
        ...
        acc->code_changed = true;
    } else if (agent_str_starts(path, "tests/harness/include/test/")) {
                   ...
                   struct json_value *result)
{
    ...
    agent_push_subsystem(&subsystems, "native_agent_api",
                         ...
                         "cognition/controllers/src/agent_controller.c, cognition/controllers/src/agent_contracts_controller.c, cognition/controllers/src/agent_anchor_status_controller.c, cognition/controllers/src/agent_background_quality.c, cognition/controllers/src/agent_lane_runtime.c, cognition/controllers/src/agent_lanes_controller.c, cognition/controllers/src/agent_liveness_controller.c, cognition/controllers/src/agent_runtime_controller.c, cognition/controllers/include/controllers/agent_contracts.def, engine/entry/main.c",
                         "docs/AGENT_API.md",
    ...
    agent_push_subsystem(&subsystems, "background_quality_lanes",
                         ...
                         "cognition/controllers/src/agent_background_quality.c, tools/scripts/background_quality_lane.sh, platform/deploy/zclassic23-fuzz.service, platform/deploy/zclassic23-coverage.service",
                         "docs/work/fast-path.md",
                         "make_lint_gates");
                     ...
                     struct json_value *result)
{
    ...
    json_push_kv_str(&dev, "hot_path_buckets",
                     "core/modules/chain, core/params, core/modules/crypto, platform/modules/sha3, core/modules/primitives, core/modules/sapling, core/modules/script, core/modules/validation");
    ...
    json_push_kv_str(&history, "provenance",
                     "canonical mainnet transaction fetched from zclassicd getrawtransaction; see tests/harness/src/fixture_tx_oversize_478544.c and docs/CONSENSUS_PARITY_DOCTRINE.md");
