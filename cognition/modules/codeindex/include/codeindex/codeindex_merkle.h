 ...
 * "what does this checkout contain" is one 32-byte answer and "did core/modules/net
 ...
 * numbers (tests/harness/src is the worst case here), not estimates, and they are
 ...
 * verbatim, so "/core/modules/net" cannot reproduce "core/modules/net"'s digest — which is
...
enum {
     ...
     * repository produces today (tests/harness/src alone contributes ~935). */
