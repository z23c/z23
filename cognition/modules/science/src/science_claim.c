...
/* Every multi-byte field goes through platform/modules/base's one byte-order codec. There
 ...
 * a u32 because platform/modules/base ships no big-endian u16 codec, and two extra bytes
