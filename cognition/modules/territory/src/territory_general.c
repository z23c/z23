 ...
 * The '/' requirement is what keeps "core/modules/net" from swallowing "lib/network".
 * Passing a territory's own name with no trailing component (a gate that
 * says `core/modules/net` and nothing else) still matches, which is intended: naming
