...
// signature cognition/modules/session declares; the catalog call inside already returns
                    ...
                    struct agent_plan *out)
{
     ...
     * digest and the Ed25519 audit signature cover (cognition/modules/session/src/
