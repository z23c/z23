 ...
 * config/src/bundle_exporter_generations.c (the directory work) and
 * config/src/bundle_exporter.c (the standing exporter that drives it).
 *
 * Split out of config/src/bundle_exporter.c when that file passed its shape
 * ceiling. Non-Windows only: config/src/bundle_exporter.c refuses every export
