 ...
 * config/src/consensus_state_install_derived_state.c (the reconciliation) and
 * config/src/consensus_state_install_runtime.c (the install engine that runs
 * it once activation has durably committed).
 *
 * Split out of config/src/consensus_state_install_runtime.c when that file
