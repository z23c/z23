 ...
 * all in cognition/modules/session/agent_broker.h, and this file only reads what the
 ...
 * are members of the same reloadable island (engine/composition/hotswap_islands.def). */
