...
(`contexts/commons/modules/vcs/include/vcs/zcode_c23_corpus_census.h` — the authority); the
...
build/bin/zclassic23 zcode commons corpus verify \
    --checkpoint="$(cat contexts/commons/corpus/checkpoint-000001.hex)"
build/bin/zclassic23 zcode commons corpus shard verify \
    --shard="$(cat contexts/commons/corpus/shard-000001-0.hex)"
```
...
(`--register-corpus --census-def contexts/commons/corpus/scopes.def`). Prove it end to end
with:
