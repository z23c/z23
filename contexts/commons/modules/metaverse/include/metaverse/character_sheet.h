 ...
 * readouts are computed once, inside platform/modules/astro, and stored in the chart, so
 ...
 * platform/modules/astro builds its trigonometric tables on first use, though, so a
 ...
 *
 * The latitude limit is platform/modules/astro's and is a refusal rather than an
 ...
 *
 * Returns false for a NULL argument, an invalid seed, a chart platform/modules/astro
