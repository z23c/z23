 ...
 * as every exact-path file in platform/modules/astro — see platform/modules/astro/src/astro_priv.h for
 ...
 *
 *   - those readouts were computed once inside platform/modules/astro and stored in the
...
{
    /* astro_position's fields are bounded by platform/modules/astro's own contract (sign
     ...
     * platform/modules/astro defect rather than report it, so the bound is asserted by the
...
/* Equal houses from the ascendant, 1..12 — the house system platform/modules/astro
