 ...
 * core/modules/crypto Ed25519 and platform/modules/sha3 SHA3-256 exactly as contexts/commons/modules/vcs
 * commons_admission.v1 and contexts/market/modules/zswap zswap_quote.v1 already do.
 *
 * WHAT THIS IS NOT
 * ----------------
 ...
 * contexts/market/services/include/services/market_moderation_service.h -- lib/ may not
 ...
 * (engine/models/include/models/review_state.h): unreviewed 0, reviewed_ok 1,
