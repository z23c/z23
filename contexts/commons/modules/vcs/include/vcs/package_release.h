 ...
 * content.v2 package root (contexts/commons/modules/vcs/package_manifest.* — one root commits
 ...
 * broker); private keys never enter contexts/commons/modules/vcs.
 *
 ...
 *              (the acceptance layer, contexts/commons/modules/vcs/package_accept.*, enforces
