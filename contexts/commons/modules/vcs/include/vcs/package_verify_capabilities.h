 ...
 * gate runs in THIS tree, against THIS tree's engine/composition/module_capabilities.def,
 ...
 *
 * The derivation needs symbol -> class knowledge (engine/composition/capability_symbols.def
 ...
 *
 * Run over the ten registry packages against engine/composition/capability_symbols.def,
...
struct vcs_pkgcap_options {
    ...
    /* The symbol -> class table, in engine/composition/capability_symbols.def row form.
