 ...
 *
 * Wired into BOTH transport dispatch chains (core/modules/net/src/onion_service.c and
 * core/modules/net/src/https_server.c) via a `/n/` and `/names` path prefix, the same
