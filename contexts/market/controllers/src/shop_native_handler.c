 ...
 *     core/modules/net/src/tor_integration.c); the stub-vs-real build fact is read
 ...
 *     core/modules/net's register_self() folds into the node's own /directory.json
 ...
 *
 * Bound in engine/composition/commands/store.def. The closed HOT_FORK story executes the
