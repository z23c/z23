 ...
 * exception as core/modules/net/src/rom_seed_ledger.c and
 * engine/modules/storage/src/peers_projection.c; every step goes through the
 * AR_STEP_* wrappers.
 *
 ...
 * ZNAM render guard above: core/modules/net ranks below engine/modules/framework
 ...
 * core/modules/net ranks BELOW contexts/naming/modules/znam in the module graph
 ...
 * core/modules/net/src/peer_strategy.c records that it "blocks for tens of
 ...
 * (core/modules/net/src/peer_strategy_worker.c), probing off the boot path and
 ...
 * engine/models/src/database_schema.c). So this is an index max lookup, not
...
void onion_service_directory_register_refresh(void)
{
    ...
    /* A ROOT child, not supervisor_register_in_domain(net, ...): core/modules/net
