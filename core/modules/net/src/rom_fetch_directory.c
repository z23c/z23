 ...
 * manifest. Split out of core/modules/net/src/rom_fetch.c (which is at its shrink-only
 ...
 *
 * After that the call returns false and engine/composition/src/boot_bundle_fetch.c's
