 ...
 * persistence (mirrors platform/modules/util/src/boot_status.c's crash-safety pattern),
 ...
 * the `unhealthy` health rollup, engine/controllers/src/diagnostics_health_
