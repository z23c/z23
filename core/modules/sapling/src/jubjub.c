 ...
 * branchless. See tests/harness/src/test_sapling_crypto.c for the
 ...
 * in core/modules/sapling/src/fr.c. */
...
/* Same suppression, and for the same reason, as core/modules/sapling/src/fr.c: the
