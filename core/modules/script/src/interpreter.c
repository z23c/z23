 ...
 *
 * core/modules/script/src/interpreter.c — adapter layer for the pure script VM.
 *
 ...
 *
 * The split keeps allocator-side glue in core/modules/script while consensus
 ...
 * is supplied by the caller (core/modules/validation typically pairs it with
