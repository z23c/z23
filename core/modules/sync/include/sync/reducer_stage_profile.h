...
enum reducer_profile_field {
     ...
     *
     * SCOPE: every field here is emitted from engine/jobs/src/proof_validate_stage.c
     ...
     * clock pair inside the per-tx sweep in engine/jobs/src/proof_validate_verify.c;
