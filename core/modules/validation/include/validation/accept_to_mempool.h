 ...
 *
 * Before this existed, the P2P `tx` handler (core/modules/net/src/msg_tx.c) and
 ...
 * relayed.
 *
 * Parameters are plain primitives so the helper lives in core/modules/validation
 * (a layer both core/modules/net and app/controllers already depend on) without
