 ...
 * core/modules/validation/include/validation/main_constants.h. That definition
 ...
 * thread has not installed it yet (core/modules/sapling/src/sprout.c); the
 * Sapling spend/output verifiers do the same on a NULL VK
 * (core/modules/sapling/src/sapling.c), and the verification context allocation
