...
| `zcode work map` | ready | read / read / operator · fast/low | `workspace`, **`map_root`**, `offset`, `limit`, `proof_datadir`, `action_id`, `node_index` | `zcl.zcode_work_map.v1` | `z23 zcode work map --input='{"map_root":"<sha3-root>","limit":4}'` | Inspect one exact work-map hierarchy |
