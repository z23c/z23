...
via the wipe-to-tip stopwatch (recorded 515 s PASS on 2026-08-21; the 2026-09-11 495 s claim is unverified). Remaining
◐ criteria: **C5** (hermetic real ivk-decrypt + memo-bound store
slice and a recorded rung-A operator PASS exist; remote buyer transport
still needs the owner store-dispatch decision), **C6** (needs a clean 168h
