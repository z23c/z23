...
| ChaCha20-Poly1305 — `lib/crypto/src/chacha20poly1305.c` | portable — no AVX2 ChaCha tier | n/a | portable | n/a | the sapling note-encryption groups that consume it | none |
