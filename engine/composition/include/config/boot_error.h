 ...
 * engine/modules/kernel/include/kernel/command_registry.h). Pre-dispatch code — argv
 * handling in engine/entry/main.c, the datadir lock, app_init — could not reach that
