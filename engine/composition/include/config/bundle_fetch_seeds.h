 ...
 * engine/composition/src/boot_bundle_fetch.c (bbf_assemble_seeds, the instant-on bundle
 * discovery/fetch path) and engine/composition/src/boot_services.c (the legacy
 ...
 * engine/composition/src/boot_bundle_fetch_seeds.c, which honours ctx->file_service_peer
