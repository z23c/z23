 ...
 * boot_step_select_chain_and_datadir (engine/composition/src/boot.c) derives the selected
 ...
 * engine/composition/src/boot_bundle_manifest_pick.c. */
                                ...
                                const struct rom_fetch_manifest *m)
{
     ...
     * fs_server_start (engine/composition/src/boot_auto_install_bundle.c). That ordering
 ...
 * engine/composition/src/consensus_state_producer_receipt.c) plus toolchain/build-input
 ...
 *     path / engine/composition/src/boot_install_consensus_bundle.c), so a lying seed at
 ...
 * engine/composition/src/boot_bundle_fetch_discovery_outcome.c (split out to keep this
