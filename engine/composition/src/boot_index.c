 ...
 *
 * Part of the boot composition root (engine/composition/src/). Owns the consensus
 ...
 * engine/composition/src/boot_address_backfill.c; the on-disk block-file scan lives
 * in engine/composition/src/boot_block_file_scan.c. Block index flat-file save/load
 * and SQLite cache functions live in engine/services/src/block_index_loader.c. */
 ...
 * have been extracted to engine/services/src/block_index_loader.c.
 ...
 * engine/composition/src/boot_address_backfill.c. */

/* Block-file scan (scan_block_files_mark_data + helpers) moved to
 * engine/composition/src/boot_block_file_scan.c. */
