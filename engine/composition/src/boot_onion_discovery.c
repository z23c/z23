 ...
 *
 * The config/-side implementation of core/modules/net's signed discovery port
 * (net/onion_discovery.h onion_signed_peer_source_fn). core/modules/net is
 * ranked below contexts/commons/modules/vcs in engine/composition/lib_module_order.def and may not
