 ...
 * boundary. Contract: engine/composition/src/bundle_exporter_generations_internal.h.
 */
 ...
 * engine/composition/src/bundle_exporter.c, so no pathname in a bundles directory is ever
