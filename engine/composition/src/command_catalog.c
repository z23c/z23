 ...
 *
 * This file expands the declarative X-macro files under engine/composition/commands into
...
#include "../commands/fleet_agents.def"
#include "../commands/fleet.def"
#include "../commands/fleet_enrol.def"
 ...
 * the compiled catalog, since it is keyed by catalog offset. `engine/modules/kernel` may
