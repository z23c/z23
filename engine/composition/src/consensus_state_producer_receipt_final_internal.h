 ...
 * engine/composition/src/consensus_state_producer_receipt_final.c (the row I/O) and
 * engine/composition/src/consensus_state_producer_receipt.c (finalize(), its only caller).
 *
