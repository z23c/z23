 ...
 * engine/composition/commands/app_features.def until the app-write plan/commit handshake
 * lands — the wallet-send precedent (engine/composition/commands/core.def). */
 ...
 * in engine/modules/hotswap/include/hotswap/hotswap.h). Stages every native command leaf
