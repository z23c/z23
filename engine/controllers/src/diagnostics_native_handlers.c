 ...
 * engine/composition/hotswap_swappable.def since that manifest was written, but carried
...
ZCL_HOTSWAP_TRAMPOLINE(module_tramp_node_logs, zcl_native_node_log_body)
