 ...
 * real rc (engine/models/src/database.c). Bounded attempts + name-a-blocker on
 ...
 * loader, engine/composition/src/boot.c sapling_tree_verify_at_saved_height, trusts that
