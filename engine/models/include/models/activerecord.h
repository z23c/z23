 ...
 * Implementations live in contexts/explorer/views/src/format_helpers.c (string utility)
 * and engine/models/src/shared_validators.c. Declared here so model files
 ...
 *     Canonically `struct node_db *` (engine/models/include/models/database.h).
 *     The macros below only do `(ndb)->db` to extract the SQLite handle,
 *     so any aliased handle struct works — for example
 *     `struct wallet_sqlite *` (contexts/wallet/modules/wallet/include/wallet/wallet_sqlite.h),
