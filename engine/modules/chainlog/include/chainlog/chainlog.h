 ...
 *
 * WHY THIS EXISTS, AND WHY IT IS NOT engine/modules/storage/event_log
 * -------------------------------------------------------
 ...
 * the head hash with its own key (contexts/wallet/modules/zid) and stores that elsewhere — this
