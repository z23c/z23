 ...
 *
 * It carries a producer's public key and stops there. Signing is contexts/wallet/modules/zid's,
 ...
 *
 * A DECLARED HOLE, wired the way cognition/modules/territory's trust ledger is wired. The
