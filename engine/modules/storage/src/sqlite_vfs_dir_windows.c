 ...
 * of platform/modules/platform/src/directory_transaction.c), with post-open refusal of
 ...
 * platform/modules/platform/src/directory_transaction.c: no separators or drive/stream
