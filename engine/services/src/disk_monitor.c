...
{
    /* Wire the models/db_txn.h hexagonal seam here (not in engine/composition/src/boot.c)
     * so engine/models/ never needs to #include engine/services/disk_monitor.h
