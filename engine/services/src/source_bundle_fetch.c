...
// free-form message cannot be asserted on; tests/harness/src/
 ...
 * (contexts/commons/modules/vcs/src/package_swarm*.c, source_package_checkout.c). It solves a
 ...
 * FS_ROM_LIST_ARTS_MAX + 64 (core/modules/net/src/file_service.c); this is comfortably
                                       ...
                                       size_t *len_out)
{
    *len_out = 0;
     ...
     * tests/harness/src/test_source_bundle_fetch.c's planted-resume case derives
 ...
 * writes (core/modules/net/src/rom_peer_scoring.c) is WRITE-ONLY in production:
