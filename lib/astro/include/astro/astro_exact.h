 ...
 *
 * astro_exact — the one numeric type lib/astro computes charts in, and the
 ...
 * this header and defined in the ONLY translation unit of lib/astro that is
 ...
 * .c file in lib/astro carries `#pragma GCC poison double float` after its
 ...
 * Nothing inside lib/astro calls this. */
