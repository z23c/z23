...
/* The error accumulator lives in error_ring.c; event_log_init resets it
 * through the public accessor rather than keeping a second definition. */
...
void event_log_init(void)
{
    ...
    error_ring_init(error_ring_global());
}
