 ...
 * container primitives that postmortem_archive.c defines and postmortem.c
 * consumes, plus the tar block size both sides pad to.
 *
 * postmortem.c owns the capsule itself: the crash hook, the async-signal-safe
 * capture, the manifest, and the capsule inventory/list/prune surface.
