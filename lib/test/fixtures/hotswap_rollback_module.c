 ...
 * under lib/test/fixtures/, which the build globs never pick up). The Makefile
 ...
 * running. That is the observation lib/test/src/test_hotswap_rollback.c uses to
 ...
 * that row owns. core.status is the probe leaf config/hotswap_eligible.def
