 ...
 * ----------------------------------------------
 *   lib/test/src/test_params_vk_embedded.c   — the VK blobs are byte-exact,
 ...
 *   lib/test/src/test_seed_bootstrap_doors.c — no dead port, no double
 ...
 *   lib/test/src/test_boot_matrix.c          — every boot cell reaches a NAMED
...
int test_cold_join_sovereign(void)
{
    ...
    printf("\n-- P4: validation armed with no parameter files, proving is not --\n");
    {
        ...
        printf("cold_join: NOTE P4 is the honest pair. A cold node can CHECK "
               ...
               "lib/test/src/test_params_vk_embedded.c.\n");
    }
    ...
    printf("\n-- P6: bootstrap independence (the weak one) --\n");
    {
         ...
         * array last (lib/net/src/connman.c, run_onion_seed_pass). That
        ...
        printf("cold_join: NOTE reachability of any door is NOT graded here. "
               ...
               "lib/test/src/test_seed_bootstrap_doors.c.\n");
    }
