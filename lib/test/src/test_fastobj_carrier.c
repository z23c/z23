 ...
 *   1. prepare the tiny-lines fixture package (lib/vcs only — the
...
int test_fastobj_carrier(void)
{
    ...
    /* 1. prepare the tiny-lines fixture (lib/vcs only — the candidate
     * proof action needs no signed release). */
    FC_CHECK("tiny-lines fixture copied to scratch",
             fcw_copy_tree("lib/test/fixtures/zcode/tiny-lines", pkg));
