 ...
 *
 * test_science — the lib/science gate.
 *
...
static int case_no_status_setter(void)
{
    int failures = 0;
    size_t len = 0;
    char *hdr = slurp("lib/science/include/science/science_claim.h", &len);
...
#define TDIFFERS(what, mutate)                                            \
    ...
    TDIFFERS("the territory changes", rv.territory = "lib/chainlog");
