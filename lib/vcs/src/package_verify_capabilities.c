 ...
 * config/capability_symbols.def for why it is spelled as a CAP_ id. */
 ...
 *
 * No fseek/ftell: neither is classified in config/capability_symbols.def, and
...
/* Parse config/capability_symbols.def row form:
