 ...
 * platform/packaging/release/build_release.sh can package a windows-x86_64 runtime as
 ...
 * for; platform/packaging/install/install.sh carries that one, because it has to pick
                        ...
                        char out[FD_TRIPLE_MAX])
{
     ...
     * engine/composition/platform/macos_capabilities.def and docs/work/BOOTSTRAP_PLAN.md
