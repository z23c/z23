...
int main(void)
{
     ...
     * platform/modules/platform/src/logical_cpu.c documents when it defines its own
     * baseline, so the branch stays here rather than assuming a define this
     * TU may not receive. platform/modules/platform/src/logical_cpu.c carries the same
