...
#
# Same four steps as platform/packaging/install/install.sh, and nothing else: name this
...
#   1. platform/packaging/release/build_release.sh does package windows-x86_64 — a real
...
# cutter (platform/packaging/release/build_release.sh --front-door) writes the real
...
# Same rule as install.sh and platform/modules/install/src/front_door_platform.c: fold only
