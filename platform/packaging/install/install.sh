...
# (tools/install/z23_bootstrap.c over platform/modules/install). They are written once, in
...
#
# PUBLISHED, not BUILT. platform/packaging/release/build_release.sh packages a
...
# Same rule as platform/modules/install/src/front_door_platform.c: fold only the
