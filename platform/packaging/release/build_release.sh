...
#
# Usage:
#   platform/packaging/release/build_release.sh [--bin DIR] [--out DIR] [--platform P]
#   platform/packaging/release/build_release.sh --front-door [--bin DIR] [--out DIR]
#   platform/packaging/release/build_release.sh --print-runtime-platforms
#   platform/packaging/release/build_release.sh --print-bootstrap-platforms
#   platform/packaging/release/build_release.sh --selftest
#
...
#
#   <origin>/                              platform/packaging/install/install.sh
#   <origin>/install.ps1                   platform/packaging/install/install.ps1
...
POSIX_SHIM="$REPO_ROOT/platform/packaging/install/install.sh"
WINDOWS_SHIM="$REPO_ROOT/platform/packaging/install/install.ps1"
package_front_door() {
