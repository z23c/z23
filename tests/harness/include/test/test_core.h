 ...
 * parent that is not absolute (platform/modules/platform/src/private_file.c), so every
...
/* The make_lint_gates family — see tests/harness/src/test_make_lint_gates.c for the
 ...
 *
 *   FAIL at tests/harness/src/test_foo.c:412 (got != want): 7 != 9
 *
 ...
 * assertion sites in tests/harness/src that round trip was paid constantly.
 *
