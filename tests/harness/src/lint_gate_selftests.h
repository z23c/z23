...
#define COINS_FIXTURE_DST_REL "engine/controllers/src/_coins_lookup_guard_fixture_tmp.c"
#define OBS_FIXTURE_SRC_REL "tests/harness/fixtures/observability_unpaired_stderr_fixture.c"
#define OBS_FIXTURE_DST_REL "engine/controllers/src/_observability_lint_fixture_tmp.c"
#define OBS_OK_FIXTURE_SRC_REL "tests/harness/fixtures/observability_paired_stderr_fixture.c"
#define OBS_OK_FIXTURE_DST_REL "engine/controllers/src/_observability_ok_lint_fixture_tmp.c"
#define RAW_MALLOC_FIXTURE_DST_REL "engine/controllers/src/_raw_malloc_lint_fixture_tmp.c"
#define RAW_MALLOC_OK_FIXTURE_DST_REL "engine/controllers/src/_raw_malloc_ok_lint_fixture_tmp.c"
...
#define HOTSWAP_SERVICE_BAD_MANIFEST_REL \
    "tests/harness/fixtures/hotswap_services_bad.def"
#define HOTSWAP_SERVICE_STALE_CONTRACT_REL \
    "tests/harness/fixtures/hotswap_services_stale_contract.def"
#define HOTSWAP_MANIFEST_REL "engine/composition/hotswap_eligible.def"
#define HOTSWAP_BAD_SCOPE_MANIFEST_REL \
    "tests/harness/fixtures/hotswap_manifest_bad_scope.def"
#define HOTSWAP_BAD_STATIC_MANIFEST_REL \
    "tests/harness/fixtures/hotswap_manifest_bad_static.def"
#define HOTSWAP_NO_MACRO_MANIFEST_REL \
    "tests/harness/fixtures/hotswap_manifest_no_macro.def"
#define HOTSWAP_SWAPPABLE_SCRIPT_REL \
    "tools/lint/check_hotswap_swappable_shape.sh"
#define HOTSWAP_SWAPPABLE_MANIFEST_REL "engine/composition/hotswap_swappable.def"
#define HOTSWAP_SWAPPABLE_BAD_MANIFEST_REL \
    "tests/harness/fixtures/hotswap_swappable_bad_shape.def"
#define HOTSWAP_SWAPPABLE_NOT_READY_READ_REL \
    "tests/harness/fixtures/hotswap_swappable_not_ready_read.def"
#define HOTSWAP_SWAPPABLE_DUP_LEAF_REL \
    "tests/harness/fixtures/hotswap_swappable_dup_leaf.def"
#define HOTSWAP_SWAPPABLE_BAD_STATIC_REL \
    "tests/harness/fixtures/hotswap_swappable_bad_static.def"
#define HOTSWAP_ISLAND_BAD_SCOPE_REL \
    "tests/harness/fixtures/hotswap_islands_bad_scope.def"
#define HOTSWAP_ISLAND_BAD_STATIC_REL \
    "tests/harness/fixtures/hotswap_islands_bad_static.def"
...
#define E10_SQL_FIXTURE_DST \
    "engine/controllers/src/sync_controller_e10_rawsql_fixture_tmp.c"
...
#define E5_FIXTURE_DST   "engine/jobs/src/_e5_stage_fixture_tmp_stage.c"
#define E6_SCRIPT_REL    "tools/scripts/check_one_write_path.sh"
#define E6_FIXTURE_DST   "engine/services/src/_e6_write_path_fixture_tmp.c"
#define E7_SCRIPT_REL    "tools/scripts/check_no_authoritative_ram_state.sh"
#define E7_FIXTURE_DST   "engine/services/src/_e7_ram_state_fixture_tmp.c"
