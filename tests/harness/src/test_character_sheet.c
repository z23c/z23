...
static void t_refusals(void)
{
    ...
    /* Coordinates. The limits are platform/modules/astro's and are inclusive. */
    {
 ...
 * whatever today's platform/modules/astro computes; nothing here is pinned. */
...
int test_character_sheet(void)
{
    ...
    /* platform/modules/astro builds its trigonometric tables on first use and that build
