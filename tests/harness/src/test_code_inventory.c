...
static bool ci_fixture(void)
{
    if (system("rm -rf " CI_FIX " && mkdir -p "
               CI_FIX "/platform/modules/demo/include/demo "
               CI_FIX "/platform/modules/demo/include/test "
               CI_FIX "/platform/modules/demo/src "
               CI_FIX "/tests/harness/src "
               CI_FIX "/build/obj/epochs/"
                      "1111111111111111111111111111111111111111111111111111111111111111 "
               CI_FIX "/contexts/commons/packages/zmini/include/zmini "
               CI_FIX "/contexts/commons/packages/zmini/src "
               CI_FIX "/tools/dev "
               CI_FIX "/tools/lint") != 0) return false;
    bool ok = ci_write(CI_FIX "/platform/modules/demo/include/demo/demo.h",
        ...
        ci_write(CI_FIX "/platform/modules/demo/include/demo/other.h",
        "/* purpose: Exercise a same-named, path-distinct inline. */\n"
        "#ifndef OTHER_H\n#define OTHER_H\n#include <stdbool.h>\n"
        "static inline int local_pick(int value) { return value - 1; }\n"
        "int other_use_local(int value);\n#endif\n") &&
        ci_write(CI_FIX "/platform/modules/demo/src/demo.c",
        "#include \"demo/demo.h\"\n"
        "bool demo_validate(int value)\n{\n"
        ...
        "    return result + 7;\n}\n") &&
        ci_write(CI_FIX "/platform/modules/demo/src/copy.c",
        ...
        "    return answer + 9;\n}\n") &&
        ci_write(CI_FIX "/tests/harness/src/test_fixture.c",
        "#include \"demo/demo.h\"\n"
        "int test_code_inventory_fixture(void)\n{\n"
        "    return demo_validate(2) && demo_use_local(2) == 3 ? 0 : 1;\n}\n") &&
        ci_write(CI_FIX "/contexts/commons/packages/zmini/include/zmini/zmini.h",
        "/* purpose: Tiny package fixture. */\n"
        "#ifndef ZMINI_H\n#define ZMINI_H\n"
        "int zmini_add(int a, int b);\n#endif\n") &&
        ci_write(CI_FIX "/contexts/commons/packages/zmini/src/zmini.c",
        ...
        "platform/modules/demo/src/code_inventory_semantic_fixture.c "
        "platform/modules/demo/include/test/code_inventory_semantic_fixture.h\n") &&
        ...
        "platform/modules/demo/src/demo.c\tdemo_platform\n");
    if (!ok) return false;
    return ci_copy("tests/harness/include/test/code_inventory_semantic_fixture.h",
                   CI_FIX "/platform/modules/demo/include/test/"
                          "code_inventory_semantic_fixture.h") &&
           ci_copy("tests/harness/src/code_inventory_semantic_fixture.c",
                   CI_FIX "/platform/modules/demo/src/"
...
int test_code_inventory(void)
{
    ...
    const struct ci_inventory_capability *demo = ci_cap(
        first, "platform/modules/demo/include/demo/demo.h");
    const struct ci_inventory_capability *package = ci_cap(
        first, "contexts/commons/packages/zmini/include/zmini/zmini.h");
    const struct ci_inventory_capability *other = ci_cap(
        first, "platform/modules/demo/include/demo/other.h");
    CI_ASSERT(demo != NULL);
    ...
    CI_ASSERT(demo_local && strcmp(demo_local->definition_path,
              "platform/modules/demo/include/demo/demo.h") == 0);
    CI_ASSERT(other_local && strcmp(other_local->definition_path,
              "platform/modules/demo/include/demo/other.h") == 0);
