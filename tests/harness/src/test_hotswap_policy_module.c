 ...
 *
 * engine/composition/hotswap_eligible.def documents the escape hatch that keeps a hot-swap
 ...
 * TU." engine/controllers/src/policy_native_handlers.c is the first low-level
...
#define POLICY_TU "engine/controllers/src/policy_native_handlers.c"
#define POLICY_RESIDENT_TU "engine/controllers/src/policy_native_resident.c"
#define POLICY_LEAF "zcode.package.policy.limits"
#define POLICY_ISLAND "contexts/commons/modules/vcs/src/package_policy.c"
