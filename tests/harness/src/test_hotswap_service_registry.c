...
static const struct zcl_hotswap_service_contract k_contract = {
    ...
    .source_tu = "engine/services/src/test_arithmetic.c",
...
static int t_manifest_mapping(void)
{
    ...
    TEST("service source and private header map to one resident-owned probe") {
        ...
        ASSERT(zcl_hotswap_service_contract_source_for_path(
                   "contexts/commons/services/src/zcode_c23_corpus_service.c") == NULL);
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                      ...
                      "contexts/commons/services/src/zcode_c23_economics_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_c23_economics_service.h"),
                      "contexts/commons/services/src/zcode_c23_economics_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/market_purchase_view_service.c"),
                      "contexts/market/services/src/market_purchase_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/market/services/include/services/market_purchase_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/market/services/include/services/market_purchase_view_service.h"),
                      "contexts/market/services/src/market_purchase_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/market_moderation_view_service.c"),
                      "contexts/market/services/src/market_moderation_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/market_moderation_view_internal.h"),
                      "contexts/market/services/src/market_moderation_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/market/services/include/services/market_moderation_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/market/services/include/services/market_moderation_view_service.h"),
                      "contexts/market/services/src/market_moderation_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/commons/services/src/zcode_package_view_service.c"),
                      "contexts/commons/services/src/zcode_package_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/commons/services/include/services/zcode_package_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_package_view_service.h"),
                      "contexts/commons/services/src/zcode_package_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_probe_for_source(
                      ...
                      "zcode.package.guide");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/commons/services/src/zcode_moderation_view_service.c"),
                      "contexts/commons/services/src/zcode_moderation_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/commons/services/include/services/zcode_moderation_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_moderation_view_service.h"),
                      "contexts/commons/services/src/zcode_moderation_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                      ...
                      "contexts/commons/services/src/zcode_workspace_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/commons/services/include/services/zcode_workspace_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_workspace_view_service.h"),
                      "contexts/commons/services/src/zcode_workspace_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                      ...
                      "contexts/commons/services/src/zcode_passport_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/commons/services/include/services/zcode_passport_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_passport_view_service.h"),
                      "contexts/commons/services/src/zcode_passport_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "cognition/services/src/zcode_goal_context_calc_service.c"),
                      "cognition/services/src/zcode_goal_context_calc_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "cognition/services/include/services/zcode_goal_context_calc_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "cognition/services/include/services/zcode_goal_context_calc_service.h"),
                      "cognition/services/src/zcode_goal_context_calc_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_probe_for_source(
                      ...
                      "zcode.work.context");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/commons/services/src/zcode_lane_view_service.c"),
                      "contexts/commons/services/src/zcode_lane_view_service.c");
        ASSERT(zcl_hotswap_service_source_for_path(
                   "contexts/commons/services/include/services/zcode_lane_view_service.h")
               == NULL);
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/commons/services/include/services/zcode_lane_view_service.h"),
                      "contexts/commons/services/src/zcode_lane_view_service.c");
        ...
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/shop_reputation_view_service.c"),
                      "contexts/market/services/src/shop_reputation_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/market/services/include/services/shop_reputation_view_service.h"),
                      "contexts/market/services/src/shop_reputation_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_probe_for_source(
                          "contexts/market/services/src/shop_reputation_view_service.c"),
                      "app.shop.reputation");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/shop_status_view_service.c"),
                      "contexts/market/services/src/shop_status_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_probe_for_source(
                          "contexts/market/services/src/shop_status_view_service.c"),
                      "app.shop.status");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/shop_want_view_service.c"),
                      "contexts/market/services/src/shop_want_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_source_for_path(
                          "contexts/market/services/src/shop_want_view_internal.h"),
                      "contexts/market/services/src/shop_want_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_contract_source_for_path(
                          "contexts/market/services/include/services/shop_want_view_service.h"),
                      "contexts/market/services/src/shop_want_view_service.c");
        ASSERT_STR_EQ(zcl_hotswap_service_probe_for_source(
                          "contexts/market/services/src/shop_want_view_service.c"),
                      "app.shop.want.list");
        ASSERT_STR_EQ(zcl_hotswap_shadow_service_for_owner(
                      ...
                      "cognition/services/src/dev_reflex_policy_service.c");
        ASSERT(zcl_hotswap_shadow_path_is_static_owner(
                   "tools/command/native_dev_command.c"));
        ASSERT(!zcl_hotswap_shadow_path_is_static_owner(
                   "cognition/services/src/dev_reflex_policy_service.c"));
        ASSERT_STR_EQ(zcl_hotswap_shadow_service_for_owner(
                          "contexts/commons/modules/vcs/src/zcode_workspace_manifest.c"),
                      "contexts/commons/services/src/zcode_workspace_view_service.c");
        ASSERT(strstr(zcl_hotswap_shadow_members_for_service(
                          "contexts/commons/services/src/zcode_workspace_view_service.c"),
                      "contexts/commons/modules/vcs/src/zcode_workspace_manifest.c") != NULL);
        ASSERT(zcl_hotswap_service_source_for_path(
                   "engine/modules/storage/src/storage.c") == NULL);
        PASS();
    } _test_next:;
    return failures;
}
...
static int t_market_purchase_view(void)
{
    ...
    TEST("marketplace calculations publish while payment authority stays static") {
        ...
        struct zcl_hotswap_service_candidate service_candidate = {
            ...
            .source_tu = "contexts/market/services/src/market_purchase_view_service.c",
            .abi_version = ZCL_HOTSWAP_SERVICE_ABI_V1,
...
static int t_zcode_package_view(void)
{
    ...
    TEST("package presentation swaps while package authority stays static") {
        ...
        struct zcl_hotswap_service_candidate service_candidate = {
            ...
            .source_tu = "contexts/commons/services/src/zcode_package_view_service.c",
            .abi_version = ZCL_HOTSWAP_SERVICE_ABI_V1,
            .vtable_size = sizeof(candidate_service),
...
static int t_zcode_workspace_view(void)
{
    ...
    TEST("workspace views swap while signatures and root authority stay static") {
        ...
        struct zcl_hotswap_service_candidate publication = {
            ...
            .source_tu = "contexts/commons/services/src/zcode_workspace_view_service.c",
            .abi_version = ZCL_HOTSWAP_SERVICE_ABI_V1,
...
static int t_zcode_goal_context_calc(void)
{
    ...
    TEST("goal-context calculation swaps while index reads and task effects stay static") {
        ...
        struct zcl_hotswap_service_candidate publication = {
            ...
            .source_tu = "cognition/services/src/zcode_goal_context_calc_service.c",
            .abi_version = ZCL_HOTSWAP_SERVICE_ABI_V1,
            .vtable_size = sizeof(candidate),
...
static int t_shop_status_view(void)
{
    ...
    TEST("shop posture rendering swaps while probes and init effects stay static") {
        ...
        struct zcl_hotswap_service_candidate publication = {
            ...
            .source_tu = "contexts/market/services/src/shop_status_view_service.c",
            .abi_version = ZCL_HOTSWAP_SERVICE_ABI_V1,
            .vtable_size = sizeof(candidate),
