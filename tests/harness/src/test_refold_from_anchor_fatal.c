 ...
 * boot_refold_from_anchor_reset (engine/composition/src/boot_refold_staged.c:274-437) FATALs
 ...
 * engine/composition/src/boot_refold_staged.c weaken the hard-assert at line 338 from
 *     if (!anchor_proven) {
 * to
 *     if (false) {
