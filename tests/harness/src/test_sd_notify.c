 ...
 * (platform/modules/util/src/sd_notify.c). No libsystemd — this exercises the real
...
/* Production sd_notify is a no-op stub on Windows (platform/modules/util/src/sd_notify.c)
