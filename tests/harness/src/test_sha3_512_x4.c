 ...
 *
 * ACCEL-ORACLE: core/modules/crypto/src/sha3_avx512.c
 *
 * Differential parity oracle + honest benchmark for the 4-way SHA3-512
 * keystream primitive (core/modules/crypto/src/sha3_avx512.c).
 *
 ...
 * cipher keystream for the file-transfer service (core/modules/net/src/file_service.c) —
