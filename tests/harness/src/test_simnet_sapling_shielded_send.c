 ...
 * WHAT THIS PROVES
 * ----------------
 *   1. An in-sim Sapling note-commitment tree (engine/modules/sim/src/simnet_sapling.c)
 ...
 * (zclassic_sapling_* in core/modules/sapling/src/sapling_prover_native.c). Routing through
