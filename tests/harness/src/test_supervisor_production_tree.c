 ...
 * chain_tip_watchdog.c (engine/services/src/chain_tip_watchdog.c:302)
...
int test_supervisor_production_tree(void)
{
     ...
     * (engine/services/src/chain_tip_watchdog.c:286-306). */
     ...
     * The platform/modules/util adapter is the shared registration path every
