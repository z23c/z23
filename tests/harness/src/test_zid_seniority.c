 ...
 *
 * The static assertions pin the advisory ceiling: contexts/wallet/modules/zid sits below core/modules/net
 * in engine/composition/lib_module_order.def and keeps a local copy of the bound, and
 ...
 * (engine/composition/src/boot_seniority.c, bsen_client_draw): the low 8
