 ...
 * name_set_text RPC write surface (engine/controllers/src/name_controller.c). */
                          ...
                          struct json_value *result)
{
     ...
     * overwriting (platform/modules/json/src/json.c) — an extra manual json_free(&v)
 ...
 * coinbase — see wallet_available_coins in contexts/wallet/modules/wallet/src/wallet.c). */
