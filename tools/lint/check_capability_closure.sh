...
# floor for THIS pair of targets, not padding. If that pair's dependency
# shape changes, this baseline may only move DOWN without review — a rise
# means either a legitimate new standalone exemption (document it above) or
# the very partial-scan regression this floor exists to catch.
