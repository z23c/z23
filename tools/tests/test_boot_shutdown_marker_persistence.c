 ...
 * Purpose: proves the clean-shutdown marker round-trips privately under the
 * datadir given as argv[1]: written owner-only, read back as clean rather
 * than unclean, and removed so the path is absent again. */
