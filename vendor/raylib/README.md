...
(`platforms/rcore_desktop_rgfw.c`) and the seven single-file dependencies those actually `#include`
(`glad.h`, `stb_image_resize2.h`, `stb_perlin.h`, `RGFW/RGFW.h`, `RGFW/deps/minigamepad.h`, plus
